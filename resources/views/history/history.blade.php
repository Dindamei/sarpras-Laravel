      ...
      <nav class="navbar default-layout col-lg-12 col-12 p-0  d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
          ...
          <a class="navbar-brand brand-logo-mini" href="index.html">
            <img src="assets/images/AduinAja.png" alt="Aduin aja" /> </a>
        </div>
              ...
              <div class="col-12">
                <div class="page-header">
                  ...
                  <div class="col-md-12 grid-margin">
                    <div class="card">
                      <div class="card-body">
                        <div class="d-flex justify-content-between">
                          <h4 class="card-title mb-0">Daftar History</h4>
                    ...
                    <form action="{{ route('history.destroy', $history->id_history) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus history ini?')">
                        @csrf
                        @method('DELETE')
